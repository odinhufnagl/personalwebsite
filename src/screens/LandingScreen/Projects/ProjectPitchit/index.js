...
useEffect(() => {
    ...
    return (
       <div className={styles.Container}>
             <h2 className={styles.Text}><span style={{color: "#66FCF1"}}>Social Network</span> for motivation and personal development</h2>
             <div className={styles.Mobile}>

                <img src={image} alt="phone" className={styles.Imagemobile} id={"cardmobile"}></img>
                </div>
